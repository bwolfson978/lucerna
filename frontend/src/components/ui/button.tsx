...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md text-body font-medium transition-all duration-150 ease-out disabled:opacity-50 disabled:cursor-not-allowed min-h-[44px]",
  {
    variants: {
      variant: {
        default:
