...
>(({ className, recommended, children, ...props }, ref) => (
  <div ref={ref} className={cn(recommended ? "card-recommended" : "card", className)} {...props}>
    {children}
  </div>
));
...
const CardHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("flex flex-col space-y-tight", className)} {...props} />
  )
);
...
const CardFooter = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("flex items-center pt-default", className)} {...props} />
  )
);
