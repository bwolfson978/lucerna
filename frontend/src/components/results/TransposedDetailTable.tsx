...
function CompactCurrencyCell({
  ...
  return (
    <input
      ...
      className={`w-full rounded border-0 bg-transparent px-1 py-0 text-center text-data-xs focus:bg-accent/5 focus:outline-none ${
        highlighted ? "font-medium text-accent" : "text-text-primary"
      }`}
      style={dataFontStyle}
    />
  );
...
export function TransposedDetailTable({
  ...
  return (
    <div className="flex text-body-sm">
      ...
      <div ref={fadeRef} className="scroll-fade min-w-0 flex-1">
        <div ref={scrollRef} className="bracket-chart-scroll overflow-x-auto pb-2">
