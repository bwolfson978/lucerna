    ...
    <div className="flex flex-col gap-default">
      <div className="flex items-center justify-between gap-2">
        <div className="flex min-w-0 items-center gap-2">
          <h3 className="text-h3 text-text-primary">Projected balances at retirement</h3>
      ...
      <div className="grid grid-cols-2 gap-tight sm:grid-cols-4 sm:gap-default">
        ...
        />
        <MetricCard label="Roth IRA/401(k)" value={formatCompactCurrency(rothAtRetirement)} />
        <MetricCard label="Total at retirement" value={formatCompactCurrency(totalAtRetirement)} />
        <MetricCard
