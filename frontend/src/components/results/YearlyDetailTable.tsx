  ...
  return (
    <div className="flex flex-col gap-tight">
      <button
        ...
        className="flex items-center gap-2 text-h3 text-text-primary hover:text-accent transition-colors duration-100"
      >
        <svg
          width="12"
          height="12"
            ...
            <tbody>
              {details.map((row, i) => (
                ...
                >
                  ...
                  <td className="py-2 pr-4 font-mono text-right text-accent">
